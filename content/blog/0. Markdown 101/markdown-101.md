...
date: '2021-04-17T13:32:20.712Z'
draft: false
permalink: 'markdown-101'
excerpt: 'This is a post to render every possible Markdown syntax available on the Internet, so that I have a local reference'
---
...
`embed:./code/index.js#L3-7`

#### With Snippets

The function to use is:

`embed:./code/api.js{snippet: "funcA"}`

And it is invoked via:

`embed:./code/api.js{snippet: "invokeA"}`
